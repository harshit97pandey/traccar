...
Ext.define("Traccar.view.RegisterController",{extend:Ext.app.ViewController,alias:"controller.register",onCreateClick:function(){var a=this.lookupReference("form"),b=a.getValues();b.personal=!!b.personal&&"on"==b.personal;b.admin=!0;a.isValid()&&Ext.Ajax.request({scope:this,method:"POST",url:"./api/users/register",jsonData:b,callback:this.onCreateReturn})},onCreateReturn:function(a,b,c){b?(this.closeView(),Ext.toast(Strings.loginCreated)):showError(c)},onPersonalClick:function(){var a=this.lookupReference("company");
a.setDisabled(!1);a.focus()},onSelectLanguage:function(a){var b,c;a=a.getValue();b=window.location.href;0<=b.indexOf("locale\x3d")?(c=b.substring(0,b.indexOf("locale")),b=b.substring(b.indexOf("locale")),b=b.substring(b.indexOf("\x3d")+1),b=0<=b.indexOf("\x26")?b.substring(b.indexOf("\x26")):"",b=c+"locale\x3d"+a+b):b=0>b.indexOf("?")?b+("?locale\x3d"+a):b+("\x26locale\x3d"+a);window.location.href=b},showError:function(a){Ext.isString(a)?Ext.Msg.alert(Strings.errorTitle,a):a.responseText?(a=Ext.decode(a.responseText),
a.details?Ext.Msg.alert(Strings.errorTitle,a.details):Ext.Msg.alert(Strings.errorTitle,a.message)):a.statusText?Ext.Msg.alert(Strings.errorTitle,a.statusText):Ext.Msg.alert(Strings.errorTitle,Strings.errorConnection)}});
...
function(){Ext.toast("Connection to server established")};websocket.onclose=function(){Ext.toast("Connection to server closed")};websocket.onmessage=function(a){var c,e,d,f,h;message=Ext.decode(a.data);a=message.body;if("position"==message.type){d=a.devices;f=a.positions;c=Ext.getStore("Devices");e=Ext.getStore("LatestPositions");for(a=0;a<d.length;a++)(h=c.findRecord("id",d[a].id,0,!1,!1,!0))&&h.set({status:d[a].status,lastUpdate:d[a].lastUpdate},{dirty:!1});for(a=0;a<f.length;a++)(d=e.findRecord("deviceId",
f[a].deviceId,0,!1,!1,!0))?d.set(f[a]):e.add(Ext.create("Traccar.model.Position",f[a]))}else"alert"==message.type&&(alertsStore=Ext.getStore("Alerts"),alertsStore.add(Ext.create("Traccar.model.Alert",a.message)))};websocket.onerror=function(a){Ext.toast("Server connection error: "+a.data)}}});
